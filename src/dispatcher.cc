...
>>>>>>> a76c441... further progress on proxy handler, need some input
=======
>>>>>>> 5d83bde... Move handler info back into NginxConfig, allowing access to handler block info in each passed config param
=======
